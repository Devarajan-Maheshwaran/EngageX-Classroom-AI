...
def generate_pdf(report: StudentReportData, session_title: str = 'EngageX Session') -> bytes:
    ...
    if report.quiz_rows:
        ...
        for qr in report.quiz_rows:
            correct_str = ('✓' if qr['is_correct'] is True else '✗' if qr['is_correct'] is False else '—')
    ...
    story.append(Paragraph('Generated by EngageX — Agentic AI Classroom System', small_style))
